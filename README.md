...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad_topology_normalizer.git
cd nomad_topology_normalizer
...
nomad_topology_normalizer==x.y.z
```
...
```sh
pip install dist/nomad_topology_normalizer-0.1.0
```
